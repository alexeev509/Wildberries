...
@Deprecated(since = "This is only example")
public class SheetsQuickstart {
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        //Read our excel
        ExcelReader.read("/Users/alekseevaroslav/Downloads/0 5.xlsx", "Sheet1");

        //
        // Build a new authorized API client service.
        final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
        final String spreadsheetId = "1rXjvjAk_9mRoCPoto1Gh7FDWIc9CCF_t687N1R2U3o0";
        String range = "A2:B";
        Sheets service =
        ...
        requestBody.setValues(
                Arrays.asList(
                        Arrays.asList("Bill", "Male"),
                        Arrays.asList("Alexey", "Male")));
        ...
        System.out.println(execute.getUpdates().getUpdatedRows());
    }
}
